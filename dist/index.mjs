...
function wn(r) {
  ...
  for (const i of r) {
    ...
    n.set(s, t), t += i.byteLength;
  }
  return n;
}
function qt(r) {
  return new Vn(r).unpack();
}
function Jt(r) {
  const e = new qn(), n = e.pack(r);
...
class Vn {
  ...
  unpack_string(e) {
    ...
    let t = 0, i = "", s, o;
    for (; t < e; )
      s = n[t], s < 160 ? (o = s, t++) : (s ^ 192) < 32 ? (o = (s & 31) << 6 | n[t + 1] & 63, t += 2) : (s ^ 224) < 16 ? (o = (s & 15) << 12 | (n[t + 1] & 63) << 6 | n[t + 2] & 63, t += 3) : (o = (s & 7) << 18 | (n[t + 1] & 63) << 12 | (n[t + 2] & 63) << 6 | n[t + 3] & 63, t += 4), i += String.fromCodePoint(o);
    return this.index += e, i;
  }
  unpack_array(e) {
    const n = new Array(e);
    for (let t = 0; t < e; t++) n[t] = this.unpack();
    return n;
  }
  unpack_map(e) {
    const n = {};
  ...
  unpack_float() {
    const e = this.unpack_uint32(), n = e >> 31, t = (e >> 23 & 255) - 127, i = e & 8388607 | 8388608;
    return (n === 0 ? 1 : -1) * i * 2 ** (t - 23);
  }
  unpack_double() {
    const e = this.unpack_uint32(), n = this.unpack_uint32(), t = e >> 31, i = (e >> 20 & 2047) - 1023, o = (e & 1048575 | 1048576) * 2 ** (i - 20) + n * 2 ** (i - 52);
    return (t === 0 ? 1 : -1) * o;
  }
  read(e) {
    const n = this.index;
...
class qn {
    ...
    if (typeof e == "string") this.pack_string(e);
      ...
      if (e === null) this._bufferBuilder.append(192);
        ...
        if (e instanceof Array) {
          ...
          if (e instanceof Blob) return e.arrayBuffer().then((t) => {
            this.pack_bin(new Uint8Array(t)), this._bufferBuilder.flush();
          });
  ...
  pack_string(e) {
    const n = this._textEncoder.encode(e), t = n.length;
    if (t <= 15) this.pack_uint8(176 + t);
    else if (t <= 65535)
      this._bufferBuilder.append(216), this.pack_uint16(t);
    else if (t <= 4294967295)
      this._bufferBuilder.append(217), this.pack_uint32(t);
    else throw new Error("Invalid length");
  ...
  pack_array(e) {
    ...
    const t = (i) => {
      if (i < n) {
        ...
        return s instanceof Promise ? s.then(() => t(i + 1)) : t(i + 1);
      }
    };
    return t(0);
  }
  ...
  pack_double(e) {
    let n = 0;
    e < 0 && (n = 1, e = -e);
    const t = Math.floor(Math.log(e) / Math.LN2), i = e / 2 ** t - 1, s = Math.floor(i * 2 ** 52), o = 2 ** 32, a = n << 31 | t + 1023 << 20 | s / o & 1048575, c = s % o;
  ...
  pack_object(e) {
    ...
    if (t <= 15) this.pack_uint8(128 + t);
      ...
      this._bufferBuilder.append(222), this.pack_uint16(t);
    else if (t <= 4294967295)
      this._bufferBuilder.append(223), this.pack_uint32(t);
    else throw new Error("Invalid length");
    const i = (s) => {
      if (s < n.length) {
        const o = n[s];
  ...
  pack_uint64(e) {
    const n = e / 4294967296, t = e % 2 ** 32;
    this._bufferBuilder.append((n & 4278190080) >>> 24), this._bufferBuilder.append((n & 16711680) >>> 16), this._bufferBuilder.append((n & 65280) >>> 8), this._bufferBuilder.append(n & 255), this._bufferBuilder.append((t & 4278190080) >>> 24), this._bufferBuilder.append((t & 16711680) >>> 16), this._bufferBuilder.append((t & 65280) >>> 8), this._bufferBuilder.append(t & 255);
  }
  pack_int8(e) {
  ...
  pack_int64(e) {
    const n = Math.floor(e / 4294967296), t = e % 2 ** 32;
    this._bufferBuilder.append((n & 4278190080) >>> 24), this._bufferBuilder.append((n & 16711680) >>> 16), this._bufferBuilder.append((n & 65280) >>> 8), this._bufferBuilder.append(n & 255), this._bufferBuilder.append((t & 4278190080) >>> 24), this._bufferBuilder.append((t & 16711680) >>> 16), this._bufferBuilder.append((t & 65280) >>> 8), this._bufferBuilder.append(t & 255);
  }
  constructor() {
    this._bufferBuilder = new zn(), this._textEncoder = new TextEncoder();
  }
}
let Gt = !0, Ht = !0;
function te(r, e, n) {
  const t = r.match(e);
  return t && t.length >= n && parseFloat(t[n], 10);
}
function q(r, e, n) {
  if (!r.RTCPeerConnection)
    return;
  const t = r.RTCPeerConnection.prototype, i = t.addEventListener;
  t.addEventListener = function(o, a) {
    if (o !== e)
  ...
  t.removeEventListener = function(o, a) {
...
function Jn(r) {
  return typeof r != "boolean" ? new Error("Argument type: " + typeof r + ". Please use a boolean.") : (Gt = r, r ? "adapter.js logging disabled" : "adapter.js logging enabled");
}
function Gn(r) {
  return typeof r != "boolean" ? new Error("Argument type: " + typeof r + ". Please use a boolean.") : (Ht = !r, "adapter.js deprecation warnings " + (r ? "disabled" : "enabled"));
}
function Kt() {
...
function Xe(r, e) {
  Ht && console.warn(r + " is deprecated, please use " + e + " instead.");
}
function Hn(r) {
  ...
  if (n.userAgentData && n.userAgentData.brands) {
    const t = n.userAgentData.brands.find((i) => i.brand === "Chromium");
    if (t)
      return { browser: "chrome", version: parseInt(t.version, 10) };
  }
  if (n.mozGetUserMedia)
    e.browser = "firefox", e.version = parseInt(te(
      n.userAgent,
      /Firefox\/(\d+)\./,
      1
    ));
  else if (n.webkitGetUserMedia || r.isSecureContext === !1 && r.webkitRTCPeerConnection)
    e.browser = "chrome", e.version = parseInt(te(
      n.userAgent,
      /Chrom(e|ium)\/(\d+)\./,
      2
    ));
  else if (r.RTCPeerConnection && n.userAgent.match(/AppleWebKit\/(\d+)\./))
    e.browser = "safari", e.version = parseInt(te(
      n.userAgent,
      /AppleWebKit\/(\d+)\./,
      1
    )), e.supportsUnifiedPlan = r.RTCRtpTransceiver && "currentDirection" in r.RTCRtpTransceiver.prototype, e._safariVersion = te(
      n.userAgent,
      /Version\/(\d+(\.?\d+))/,
      1
    );
...
function Yt(r) {
  return at(r) ? Object.keys(r).reduce(function(e, n) {
    const t = at(r[n]), i = t ? Yt(r[n]) : r[n], s = t && !Object.keys(i).length;
    return i === void 0 || s ? e : Object.assign(e, { [n]: i });
  }, {}) : r;
}
function Je(r, e, n) {
  !e || n.has(e.id) || (n.set(e.id, e), Object.keys(e).forEach((t) => {
    t.endsWith("Id") ? Je(r, r.get(e[t]), n) : t.endsWith("Ids") && e[t].forEach((i) => {
      Je(r, r.get(i), n);
    });
  }));
}
function ct(r, e, n) {
  const t = n ? "outbound-rtp" : "inbound-rtp", i = /* @__PURE__ */ new Map();
  if (e === null)
    return i;
  const s = [];
  return r.forEach((o) => {
    ...
    r.forEach((a) => {
      a.type === t && a.trackId === o.id && Je(r, a, i);
    });
  }), i;
}
const ft = Kt;
function Qt(r, e) {
  const n = r && r.navigator;
  if (!n.mediaDevices)
    return;
  const t = function(a) {
    ...
    return Object.keys(a).forEach((f) => {
      if (f === "require" || f === "advanced" || f === "mediaSource")
        return;
      const u = typeof a[f] == "object" ? a[f] : { ideal: a[f] };
      ...
      if (u.ideal !== void 0) {
        ...
        let d = {};
        typeof u.ideal == "number" ? (d[l("min", f)] = u.ideal, c.optional.push(d), d = {}, d[l("max", f)] = u.ideal, c.optional.push(d)) : (d[l("", f)] = u.ideal, c.optional.push(d));
      }
      u.exact !== void 0 && typeof u.exact != "number" ? (c.mandatory = c.mandatory || {}, c.mandatory[l("", f)] = u.exact) : ["min", "max"].forEach((d) => {
        u[d] !== void 0 && (c.mandatory = c.mandatory || {}, c.mandatory[l(d, f)] = u[d]);
      });
    ...
    if (a = JSON.parse(JSON.stringify(a)), a && typeof a.audio == "object") {
      const f = function(u, l, d) {
        l in u && !(d in u) && (u[d] = u[l], delete u[l]);
      };
      a = JSON.parse(JSON.stringify(a)), f(a.audio, "autoGainControl", "googAutoGainControl"), f(a.audio, "noiseSuppression", "googNoiseSuppression"), a.audio = t(a.audio);
    }
    if (a && typeof a.video == "object") {
      let f = a.video.facingMode;
      f = f && (typeof f == "object" ? f : { ideal: f });
      const u = e.version < 66;
      if (f && (f.exact === "user" || f.exact === "environment" || f.ideal === "user" || f.ideal === "environment") && !(n.mediaDevices.getSupportedConstraints && n.mediaDevices.getSupportedConstraints().facingMode && !u)) {
        ...
        if (f.exact === "environment" || f.ideal === "environment" ? l = ["back", "rear"] : (f.exact === "user" || f.ideal === "user") && (l = ["front"]), l)
          return n.mediaDevices.enumerateDevices().then((d) => {
            d = d.filter((g) => g.kind === "videoinput");
            let h = d.find((g) => l.some((_) => g.label.toLowerCase().includes(_)));
            return !h && d.length && l.includes("back") && (h = d[d.length - 1]), h && (a.video.deviceId = f.exact ? { exact: h.deviceId } : { ideal: h.deviceId }), a.video = t(a.video), ft("chrome: " + JSON.stringify(a)), c(a);
          });
      }
      a.video = t(a.video);
    }
    return ft("chrome: " + JSON.stringify(a)), c(a);
  }, s = function(a) {
  ...
  if (n.getUserMedia = o.bind(n), n.mediaDevices.getUserMedia) {
    ...
    n.mediaDevices.getUserMedia = function(c) {
      return i(c, (f) => a(f).then((u) => {
        if (f.audio && !u.getAudioTracks().length || f.video && !u.getVideoTracks().length)
    ...
    r.RTCPeerConnection.prototype.setRemoteDescription = function() {
      return this._ontrackpoly || (this._ontrackpoly = (t) => {
        t.stream.addEventListener("addtrack", (i) => {
          ...
          o.track = i.track, o.receiver = s, o.transceiver = { receiver: s }, o.streams = [t.stream], this.dispatchEvent(o);
          ...
          const o = new Event("track");
          o.track = i, o.receiver = s, o.transceiver = { receiver: s }, o.streams = [t.stream], this.dispatchEvent(o);
        });
      }, this.addEventListener("addstream", this._ontrackpoly)), e.apply(this, arguments);
    };
  } else
    q(r, "track", (e) => (e.transceiver || Object.defineProperty(
      e,
      "transceiver",
...
function Zt(r) {
  if (typeof r == "object" && r.RTCPeerConnection && !("getSenders" in r.RTCPeerConnection.prototype) && "createDTMFSender" in r.RTCPeerConnection.prototype) {
    ...
    const t = r.RTCPeerConnection.prototype.removeStream;
    ...
    r.RTCPeerConnection.prototype.getSenders = function() {
      ...
      return t.forEach((i) => i._pc = this), t;
...
function en(r) {
  ...
  if (!("getStats" in r.RTCRtpSender.prototype)) {
    const n = r.RTCPeerConnection.prototype.getSenders;
    n && (r.RTCPeerConnection.prototype.getSenders = function() {
  ...
  if (!("getStats" in r.RTCRtpReceiver.prototype)) {
    const n = r.RTCPeerConnection.prototype.getReceivers;
    n && (r.RTCPeerConnection.prototype.getReceivers = function() {
      const i = n.apply(this, []);
      return i.forEach((s) => s._pc = this), i;
    }), q(r, "track", (t) => (t.receiver._pc = t.srcElement, t)), r.RTCRtpReceiver.prototype.getStats = function() {
      const i = this;
      return this._pc.getStats().then((s) => ct(s, i.track, !1));
    };
  }
  ...
  r.RTCPeerConnection.prototype.getStats = function() {
    if (arguments.length > 0 && arguments[0] instanceof r.MediaStreamTrack) {
      ...
      return this.getSenders().forEach((a) => {
        a.track === t && (i ? o = !0 : i = a);
      }), this.getReceivers().forEach((a) => (a.track === t && (s ? o = !0 : s = a), a.track === t)), o || i && s ? Promise.reject(new DOMException(
...
function tn(r) {
  ...
  r.RTCPeerConnection.prototype.removeStream = function(o) {
    return this._shimmedLocalStreams = this._shimmedLocalStreams || {}, delete this._shimmedLocalStreams[o.id], t.apply(this, arguments);
  };
...
function nn(r, e) {
  ...
  if (r.RTCPeerConnection.prototype.addTrack && e.version >= 65)
    return tn(r);
  const n = r.RTCPeerConnection.prototype.getLocalStreams;
  r.RTCPeerConnection.prototype.getLocalStreams = function() {
  ...
  r.RTCPeerConnection.prototype.addStream = function(u) {
    if (this._streams = this._streams || {}, this._reverseStreams = this._reverseStreams || {}, u.getTracks().forEach((l) => {
      ...
      const l = new r.MediaStream(u.getTracks());
      this._streams[u.id] = l, this._reverseStreams[l.id] = u, u = l;
    }
    t.apply(this, [u]);
  };
  const i = r.RTCPeerConnection.prototype.removeStream;
  r.RTCPeerConnection.prototype.removeStream = function(u) {
    this._streams = this._streams || {}, this._reverseStreams = this._reverseStreams || {}, i.apply(this, [this._streams[u.id] || u]), delete this._reverseStreams[this._streams[u.id] ? this._streams[u.id].id : u.id], delete this._streams[u.id];
  }, r.RTCPeerConnection.prototype.addTrack = function(u, l) {
    ...
    if (d.length !== 1 || !d[0].getTracks().find((_) => _ === u))
      throw new DOMException(
    ...
    if (g)
      g.addTrack(u), Promise.resolve().then(() => {
        this.dispatchEvent(new Event("negotiationneeded"));
      });
    else {
      const _ = new r.MediaStream([u]);
      this._streams[l.id] = _, this._reverseStreams[_.id] = l, this.addStream(_);
    }
    return this.getSenders().find((_) => _.track === u);
  };
  function s(f, u) {
    let l = u.sdp;
    return Object.keys(f._reverseStreams || []).forEach((d) => {
      const h = f._reverseStreams[d], g = f._streams[h.id];
      l = l.replace(
        new RegExp(g.id, "g"),
        h.id
      );
  ...
  ["createOffer", "createAnswer"].forEach(function(f) {
    const u = r.RTCPeerConnection.prototype[f], l = { [f]() {
      const d = arguments;
  ...
  Object.defineProperty(
  ...
  ), r.RTCPeerConnection.prototype.removeTrack = function(u) {
    if (this.signalingState === "closed")
      throw new DOMException(
        "The RTCPeerConnection's signalingState is 'closed'.",
        "InvalidStateError"
    ...
    Object.keys(this._streams).forEach((h) => {
      this._streams[h].getTracks().find((_) => u.track === _) && (d = this._streams[h]);
    }), d && (d.getTracks().length === 1 ? this.removeStream(this._reverseStreams[d.id]) : d.removeTrack(u.track), this.dispatchEvent(new Event("negotiationneeded")));
  };
}
function Ge(r, e) {
  !r.RTCPeerConnection && r.webkitRTCPeerConnection && (r.RTCPeerConnection = r.webkitRTCPeerConnection), r.RTCPeerConnection && e.version < 53 && ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach(function(n) {
    const t = r.RTCPeerConnection.prototype[n], i = { [n]() {
      return arguments[0] = new (n === "addIceCandidate" ? r.RTCIceCandidate : r.RTCSessionDescription)(arguments[0]), t.apply(this, arguments);
    } };
    r.RTCPeerConnection.prototype[n] = i[n];
  });
}
function rn(r, e) {
  q(r, "negotiationneeded", (n) => {
    const t = n.target;
    if (!((e.version < 72 || t.getConfiguration && t.getConfiguration().sdpSemantics === "plan-b") && t.signalingState !== "stable"))
      return n;
  });
}
const ut = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  fixNegotiationNeeded: rn,
  shimAddTrackRemoveTrack: nn,
  shimAddTrackRemoveTrackWithNative: tn,
  shimGetSendersWithDtmf: Zt,
  shimGetUserMedia: Qt,
  shimMediaStream: Wt,
  shimOnTrack: Xt,
  shimPeerConnection: Ge,
  shimSenderReceiverGetStats: en
}, Symbol.toStringTag, { value: "Module" }));
function sn(r, e) {
  const n = r && r.navigator, t = r && r.MediaStreamTrack;
  if (n.getUserMedia = function(i, s, o) {
    ...
    if (n.mediaDevices.getUserMedia = function(o) {
      ...
      const o = t.prototype.getSettings;
    ...
    if (t && t.prototype.applyConstraints) {
      const o = t.prototype.applyConstraints;
      t.prototype.applyConstraints = function(a) {
...
function Kn(r, e) {
  r.navigator.mediaDevices && "getDisplayMedia" in r.navigator.mediaDevices || r.navigator.mediaDevices && (r.navigator.mediaDevices.getDisplayMedia = function(t) {
    if (!(t && t.video)) {
    ...
    return t.video === !0 ? t.video = { mediaSource: e } : t.video.mediaSource = e, r.navigator.mediaDevices.getUserMedia(t);
  });
}
function on(r) {
...
function He(r, e) {
  ...
  }, t = r.RTCPeerConnection.prototype.getStats;
  r.RTCPeerConnection.prototype.getStats = function() {
    const [s, o, a] = arguments;
    return t.apply(this, [s || null]).then((c) => {
      if (e.version < 53 && !o)
        try {
          c.forEach((f) => {
            f.type = n[f.type] || f.type;
          });
        } catch (f) {
          if (f.name !== "TypeError")
            throw f;
...
function cn(r) {
  ...
  e && (r.RTCPeerConnection.prototype.getReceivers = function() {
    const t = e.apply(this, []);
    return t.forEach((i) => i._pc = this), t;
  }), q(r, "track", (n) => (n.receiver._pc = n.srcElement, n)), r.RTCRtpReceiver.prototype.getStats = function() {
    return this._pc.getStats(this.track);
  };
}
function fn(r) {
  !r.RTCPeerConnection || "removeStream" in r.RTCPeerConnection.prototype || (r.RTCPeerConnection.prototype.removeStream = function(n) {
    Xe("removeStream", "removeTrack"), this.getSenders().forEach((t) => {
      t.track && n.getTracks().includes(t.track) && this.removeTrack(t);
    });
  });
}
function un(r) {
...
function ln(r) {
  ...
  e && (r.RTCPeerConnection.prototype.addTransceiver = function() {
    ...
    if (i) {
      ...
      a.encodings.length === 1 && Object.keys(a.encodings[0]).length === 0) && (a.encodings = t, o.sendEncodings = t, this.setParametersPromises.push(
...
const lt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  shimAddTransceiver: ln,
  shimCreateAnswer: pn,
  shimCreateOffer: hn,
  shimGetDisplayMedia: Kn,
  shimGetParameters: dn,
  shimGetUserMedia: sn,
  shimOnTrack: on,
  shimPeerConnection: He,
  shimRTCDataChannel: un,
  shimReceiverGetStats: cn,
  shimRemoveStream: fn,
  shimSenderGetStats: an
}, Symbol.toStringTag, { value: "Module" }));
function gn(r) {
  if (!(typeof r != "object" || !r.RTCPeerConnection)) {
    if ("getLocalStreams" in r.RTCPeerConnection.prototype || (r.RTCPeerConnection.prototype.getLocalStreams = function() {
      ...
      const e = r.RTCPeerConnection.prototype.addTrack;
      r.RTCPeerConnection.prototype.addStream = function(t) {
        this._localStreams || (this._localStreams = []), this._localStreams.includes(t) || this._localStreams.push(t), t.getAudioTracks().forEach((i) => e.call(
          this,
          i,
          t
        )), t.getVideoTracks().forEach((i) => e.call(
          this,
          i,
          t
        ));
      }, r.RTCPeerConnection.prototype.addTrack = function(t, ...i) {
        return i && i.forEach((s) => {
          this._localStreams ? this._localStreams.includes(s) || this._localStreams.push(s) : this._localStreams = [s];
        }), e.apply(this, arguments);
      };
    }
    "removeStream" in r.RTCPeerConnection.prototype || (r.RTCPeerConnection.prototype.removeStream = function(n) {
      this._localStreams || (this._localStreams = []);
      const t = this._localStreams.indexOf(n);
      if (t === -1)
        return;
...
function mn(r) {
  if (!(typeof r != "object" || !r.RTCPeerConnection) && ("getRemoteStreams" in r.RTCPeerConnection.prototype || (r.RTCPeerConnection.prototype.getRemoteStreams = function() {
    ...
    Object.defineProperty(r.RTCPeerConnection.prototype, "onaddstream", {
      ...
      set(n) {
        this._onaddstream && (this.removeEventListener("addstream", this._onaddstream), this.removeEventListener("track", this._onaddstreampoly)), this.addEventListener("addstream", this._onaddstream = n), this.addEventListener("track", this._onaddstreampoly = (t) => {
          t.streams.forEach((i) => {
    ...
    r.RTCPeerConnection.prototype.setRemoteDescription = function() {
      ...
      return this._onaddstreampoly || this.addEventListener("track", this._onaddstreampoly = function(i) {
        i.streams.forEach((s) => {
          if (t._remoteStreams || (t._remoteStreams = []), t._remoteStreams.indexOf(s) >= 0)
            return;
          t._remoteStreams.push(s);
          const o = new Event("addstream");
          o.stream = s, t.dispatchEvent(o);
        });
      }), e.apply(t, arguments);
    };
  }
...
function yn(r) {
  if (typeof r != "object" || !r.RTCPeerConnection)
    return;
  const e = r.RTCPeerConnection.prototype, n = e.createOffer, t = e.createAnswer, i = e.setLocalDescription, s = e.setRemoteDescription, o = e.addIceCandidate;
  e.createOffer = function(f, u) {
    const l = arguments.length >= 2 ? arguments[2] : arguments[0], d = n.apply(this, [l]);
    return u ? (d.then(f, u), Promise.resolve()) : d;
  }, e.createAnswer = function(f, u) {
    const l = arguments.length >= 2 ? arguments[2] : arguments[0], d = t.apply(this, [l]);
    return u ? (d.then(f, u), Promise.resolve()) : d;
  };
  let a = function(c, f, u) {
    const l = i.apply(this, [c]);
    return u ? (l.then(f, u), Promise.resolve()) : l;
  };
  e.setLocalDescription = a, a = function(c, f, u) {
    const l = s.apply(this, [c]);
    return u ? (l.then(f, u), Promise.resolve()) : l;
  }, e.setRemoteDescription = a, a = function(c, f, u) {
...
function _n(r) {
  ...
  if (e.mediaDevices && e.mediaDevices.getUserMedia) {
    const n = e.mediaDevices, t = n.getUserMedia.bind(n);
    e.mediaDevices.getUserMedia = (i) => t(Cn(i));
  }
  !e.getUserMedia && e.mediaDevices && e.mediaDevices.getUserMedia && (e.getUserMedia = (function(t, i, s) {
    e.mediaDevices.getUserMedia(t).then(i, s);
  }).bind(e));
}
function Cn(r) {
...
function bn(r) {
  ...
  r.RTCPeerConnection = function(t, i) {
    if (t && t.iceServers) {
      const s = [];
      for (let o = 0; o < t.iceServers.length; o++) {
        let a = t.iceServers[o];
        a.urls === void 0 && a.url ? (Xe("RTCIceServer.url", "RTCIceServer.urls"), a = JSON.parse(JSON.stringify(a)), a.urls = a.url, delete a.url, s.push(a)) : s.push(t.iceServers[o]);
      }
      t.iceServers = s;
    }
    return new e(t, i);
...
function Sn(r) {
  const e = r.RTCPeerConnection.prototype.createOffer;
  r.RTCPeerConnection.prototype.createOffer = function(t) {
    if (t) {
      typeof t.offerToReceiveAudio < "u" && (t.offerToReceiveAudio = !!t.offerToReceiveAudio);
      const i = this.getTransceivers().find((o) => o.receiver.track.kind === "audio");
      t.offerToReceiveAudio === !1 && i ? i.direction === "sendrecv" ? i.setDirection ? i.setDirection("sendonly") : i.direction = "sendonly" : i.direction === "recvonly" && (i.setDirection ? i.setDirection("inactive") : i.direction = "inactive") : t.offerToReceiveAudio === !0 && !i && this.addTransceiver("audio", { direction: "recvonly" }), typeof t.offerToReceiveVideo < "u" && (t.offerToReceiveVideo = !!t.offerToReceiveVideo);
      const s = this.getTransceivers().find((o) => o.receiver.track.kind === "video");
      t.offerToReceiveVideo === !1 && s ? s.direction === "sendrecv" ? s.setDirection ? s.setDirection("sendonly") : s.direction = "sendonly" : s.direction === "recvonly" && (s.setDirection ? s.setDirection("inactive") : s.direction = "inactive") : t.offerToReceiveVideo === !0 && !s && this.addTransceiver("video", { direction: "recvonly" });
    }
    return e.apply(this, arguments);
  };
}
...
const dt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  shimCallbacksAPI: yn,
  shimConstraints: Cn,
  shimCreateOfferLegacy: Sn,
  shimGetUserMedia: _n,
  shimLocalStreamsAPI: gn,
  shimRTCIceServerUrls: bn,
  shimRemoteStreamsAPI: mn,
  shimTrackEventTransceiver: vn
}, Symbol.toStringTag, { value: "Module" }));
function Rn(r) {
...
`);
      ...
      const t = e.splitSections(n);
      return t && t[0];
    }, e.getMediaSections = function(n) {
      const t = e.splitSections(n);
      return t.shift(), t;
    }, e.matchPrefix = function(n, t) {
      return e.splitLines(n).filter((i) => i.indexOf(t) === 0);
    }, e.parseCandidate = function(n) {
      let t;
      n.indexOf("a=candidate:") === 0 ? t = n.substring(12).split(" ") : t = n.substring(10).split(" ");
      const i = {
        foundation: t[0],
      ...
      for (let s = 8; s < t.length; s += 2)
        switch (t[s]) {
          case "raddr":
            i.relatedAddress = t[s + 1];
            break;
          case "rport":
            i.relatedPort = parseInt(t[s + 1], 10);
            break;
          case "tcptype":
            i.tcpType = t[s + 1];
            break;
          case "ufrag":
            i.ufrag = t[s + 1], i.usernameFragment = t[s + 1];
            break;
          default:
            i[t[s]] === void 0 && (i[t[s]] = t[s + 1]);
            break;
        }
      return i;
      ...
      t.push(n.foundation);
      const i = n.component;
      i === "rtp" ? t.push(1) : i === "rtcp" ? t.push(2) : t.push(i), t.push(n.protocol.toUpperCase()), t.push(n.priority), t.push(n.address || n.ip), t.push(n.port);
      const s = n.type;
      return t.push("typ"), t.push(s), s !== "host" && n.relatedAddress && n.relatedPort && (t.push("raddr"), t.push(n.relatedAddress), t.push("rport"), t.push(n.relatedPort)), n.tcpType && n.protocol.toLowerCase() === "tcp" && (t.push("tcptype"), t.push(n.tcpType)), (n.usernameFragment || n.ufrag) && (t.push("ufrag"), t.push(n.usernameFragment || n.ufrag)), "candidate:" + t.join(" ");
    }, e.parseIceOptions = function(n) {
      return n.substring(14).split(" ");
    }, e.parseRtpMap = function(n) {
      let t = n.substring(9).split(" ");
      const i = {
        payloadType: parseInt(t.shift(), 10)
        // was: id
      };
      return t = t[0].split("/"), i.name = t[0], i.clockRate = parseInt(t[1], 10), i.channels = t.length === 3 ? parseInt(t[2], 10) : 1, i.numChannels = i.channels, i;
    }, e.writeRtpMap = function(n) {
      let t = n.payloadType;
      n.preferredPayloadType !== void 0 && (t = n.preferredPayloadType);
      const i = n.channels || n.numChannels || 1;
      return "a=rtpmap:" + t + " " + n.name + "/" + n.clockRate + (i !== 1 ? "/" + i : "") + `\r
`;
    }, e.parseExtmap = function(n) {
      const t = n.substring(9).split(" ");
      return {
        id: parseInt(t[0], 10),
...
`;
      ...
      for (let o = 0; o < s.length; o++)
        i = s[o].trim().split("="), t[i[0].trim()] = i[1];
      return t;
    }, e.writeFmtp = function(n) {
      let t = "", i = n.payloadType;
...
`;
      ...
      const t = n.substring(n.indexOf(" ") + 1).split(" ");
      return {
        type: t.shift(),
        parameter: t.join(" ")
      };
      ...
      return n.preferredPayloadType !== void 0 && (i = n.preferredPayloadType), n.rtcpFeedback && n.rtcpFeedback.length && n.rtcpFeedback.forEach((s) => {
        t += "a=rtcp-fb:" + i + " " + s.type + (s.parameter && s.parameter.length ? " " + s.parameter : "") + `\r
`;
      }), t;
    }, e.parseSsrcMedia = function(n) {
      const t = n.indexOf(" "), i = {
        ssrc: parseInt(n.substring(7, t), 10)
      }, s = n.indexOf(":", t);
      return s > -1 ? (i.attribute = n.substring(t + 1, s), i.value = n.substring(s + 1)) : i.attribute = n.substring(t + 1), i;
    }, e.parseSsrcGroup = function(n) {
      const t = n.substring(13).split(" ");
      return {
        semantics: t.shift(),
        ssrcs: t.map((i) => parseInt(i, 10))
      };
    }, e.getMid = function(n) {
      const t = e.matchPrefix(n, "a=mid:")[0];
      if (t)
        return t.substring(6);
    }, e.parseFingerprint = function(n) {
      const t = n.substring(14).split(" ");
      return {
    ...
    }, e.getDtlsParameters = function(n, t) {
      return {
        role: "auto",
    ...
    }, e.writeDtlsParameters = function(n, t) {
      let i = "a=setup:" + t + `\r
`;
...
`;
    ...
    }, e.getCryptoParameters = function(n, t) {
      return e.matchPrefix(
        n + t,
        "a=crypto:"
      ).map(e.parseCryptoLine);
    }, e.getIceParameters = function(n, t) {
      ...
      let t = "a=ice-ufrag:" + n.usernameFragment + `\r
...
`), t;
      ...
      for (let a = 3; a < s.length; a++) {
        ...
        if (f) {
          const u = e.parseRtpMap(f), l = e.matchPrefix(
            n,
            "a=fmtp:" + c + " "
          );
          switch (u.parameters = l.length ? e.parseFmtp(l[0]) : {}, u.rtcpFeedback = e.matchPrefix(
            n,
            "a=rtcp-fb:" + c + " "
          ).map(e.parseRtcpFb), t.codecs.push(u), u.name.toUpperCase()) {
            case "RED":
            case "ULPFEC":
      ...
      e.matchPrefix(n, "a=extmap:").forEach((a) => {
        t.headerExtensions.push(e.parseExtmap(a));
      });
      const o = e.matchPrefix(n, "a=rtcp-fb:* ").map(e.parseRtcpFb);
      return t.codecs.forEach((a) => {
        o.forEach((c) => {
          a.rtcpFeedback.find((u) => u.type === c.type && u.parameter === c.parameter) || a.rtcpFeedback.push(c);
        });
      }), t;
    }, e.writeRtpDescription = function(n, t) {
      let i = "";
      i += "m=" + n + " ", i += t.codecs.length > 0 ? "9" : "0", i += " " + (t.profile || "UDP/TLS/RTP/SAVPF") + " ", i += t.codecs.map((o) => o.preferredPayloadType !== void 0 ? o.preferredPayloadType : o.payloadType).join(" ") + `\r
...
`, t.codecs.forEach((o) => {
      ...
      let s = 0;
      return t.codecs.forEach((o) => {
        o.maxptime > s && (s = o.maxptime);
      }), s > 0 && (i += "a=maxptime:" + s + `\r
`), t.headerExtensions && t.headerExtensions.forEach((o) => {
        i += e.writeExtmap(o);
      }), i;
    }, e.parseRtpEncodingParameters = function(n) {
      const t = [], i = e.parseRtpParameters(n), s = i.fecMechanisms.indexOf("RED") !== -1, o = i.fecMechanisms.indexOf("ULPFEC") !== -1, a = e.matchPrefix(n, "a=ssrc:").map((d) => e.parseSsrcMedia(d)).filter((d) => d.attribute === "cname"), c = a.length > 0 && a[0].ssrc;
      let f;
      const u = e.matchPrefix(n, "a=ssrc-group:FID").map((d) => d.substring(17).split(" ").map((g) => parseInt(g, 10)));
      u.length > 0 && u[0].length > 1 && u[0][0] === c && (f = u[0][1]), i.codecs.forEach((d) => {
        if (d.name.toUpperCase() === "RTX" && d.parameters.apt) {
          let h = {
            ssrc: c,
            codecPayloadType: parseInt(d.parameters.apt, 10)
          };
          c && f && (h.rtx = { ssrc: f }), t.push(h), s && (h = JSON.parse(JSON.stringify(h)), h.fec = {
            ssrc: c,
      ...
      let l = e.matchPrefix(n, "b=");
      return l.length && (l[0].indexOf("b=TIAS:") === 0 ? l = parseInt(l[0].substring(7), 10) : l[0].indexOf("b=AS:") === 0 ? l = parseInt(l[0].substring(5), 10) * 1e3 * 0.95 - 2e3 * 8 : l = void 0, t.forEach((d) => {
        d.maxBitrate = l;
      })), t;
    }, e.parseRtcpParameters = function(n) {
      const t = {}, i = e.matchPrefix(n, "a=ssrc:").map((a) => e.parseSsrcMedia(a)).filter((a) => a.attribute === "cname")[0];
      i && (t.cname = i.value, t.ssrc = i.ssrc);
      const s = e.matchPrefix(n, "a=rtcp-rsize");
      t.reducedSize = s.length > 0, t.compound = s.length === 0;
      const o = e.matchPrefix(n, "a=rtcp-mux");
      return t.mux = o.length > 0, t;
    }, e.writeRtcpParameters = function(n) {
      let t = "";
      return n.reducedSize && (t += `a=rtcp-rsize\r
...
`), t;
      ...
      if (i.length === 1)
        return t = i[0].substring(7).split(" "), { stream: t[0], track: t[1] };
      const s = e.matchPrefix(n, "a=ssrc:").map((o) => e.parseSsrcMedia(o)).filter((o) => o.attribute === "msid");
      if (s.length > 0)
        return t = s[0].value.split(" "), { stream: t[0], track: t[1] };
    }, e.parseSctpDescription = function(n) {
      const t = e.parseMLine(n), i = e.matchPrefix(n, "a=max-message-size:");
      let s;
      i.length > 0 && (s = parseInt(i[0].substring(19), 10)), isNaN(s) && (s = 65536);
      const o = e.matchPrefix(n, "a=sctp-port:");
      if (o.length > 0)
        return {
      ...
      const a = e.matchPrefix(n, "a=sctpmap:");
      if (a.length > 0) {
    ...
    }, e.writeSctpDescription = function(n, t) {
      let i = [];
      return n.protocol !== "DTLS/SCTP" ? i = [
        "m=" + n.kind + " 9 " + n.protocol + " " + t.protocol + `\r
`,
        `c=IN IP4 0.0.0.0\r
`,
...
`
        ...
        "m=" + n.kind + " 9 " + n.protocol + " " + t.port + `\r
`,
        `c=IN IP4 0.0.0.0\r
`,
...
`), i.join("");
    ...
    }, e.writeSessionBoilerplate = function(n, t, i) {
      let s;
      const o = t !== void 0 ? t : 2;
...
`;
      ...
      return t ? e.getDirection(t) : "sendrecv";
...
var Pn = Yn();
const W = /* @__PURE__ */ Rn(Pn), Qn = /* @__PURE__ */ jn({
  __proto__: null,
  default: W
}, [Pn]);
function se(r) {
  ...
  r.RTCIceCandidate = function(t) {
    if (typeof t == "object" && t.candidate && t.candidate.indexOf("a=") === 0 && (t = JSON.parse(JSON.stringify(t)), t.candidate = t.candidate.substring(2)), t.candidate && t.candidate.length) {
      const i = new e(t), s = W.parseCandidate(t.candidate);
      for (const o in s)
    ...
    return new e(t);
  }, r.RTCIceCandidate.prototype = e.prototype, q(r, "icecandidate", (n) => (n.candidate && Object.defineProperty(n, "candidate", {
    value: new r.RTCIceCandidate(n.candidate),
    writable: "false"
  }), n));
}
function Ke(r) {
  !r.RTCIceCandidate || r.RTCIceCandidate && "relayProtocol" in r.RTCIceCandidate.prototype || q(r, "icecandidate", (e) => {
    if (e.candidate) {
      const n = W.parseCandidate(e.candidate.candidate);
...
function oe(r, e) {
  ...
  const n = function(a) {
    if (!a || !a.sdp)
      return !1;
    const c = W.splitSections(a.sdp);
    return c.shift(), c.some((f) => {
      const u = W.parseMLine(f);
    ...
    const u = W.matchPrefix(
      a.sdp,
      "a=max-message-size:"
    );
    return u.length > 0 ? f = parseInt(u[0].substring(19), 10) : e.browser === "firefox" && c !== -1 && (f = 2147483637), f;
  ...
  r.RTCPeerConnection.prototype.setRemoteDescription = function() {
    ...
    if (n(arguments[0])) {
      const c = t(arguments[0]), f = i(c), u = s(arguments[0], c);
      let l;
      f === 0 && u === 0 ? l = Number.POSITIVE_INFINITY : f === 0 || u === 0 ? l = Math.max(f, u) : l = Math.min(f, u);
      const d = {};
...
function Ye(r) {
  ...
  Object.defineProperty(e, "connectionState", {
    ...
    set(n) {
      ...
      ), delete this._onconnectionstatechange), n && this.addEventListener(
        "connectionstatechange",
...
function Qe(r, e) {
  if (!r.RTCPeerConnection || e.browser === "chrome" && e.version >= 71 || e.browser === "safari" && e._safariVersion >= 13.1)
    return;
  const n = r.RTCPeerConnection.prototype.setRemoteDescription;
...
function ce(r, e) {
  if (!(r.RTCPeerConnection && r.RTCPeerConnection.prototype))
    return;
  const n = r.RTCPeerConnection.prototype.addIceCandidate;
  !n || n.length === 0 || (r.RTCPeerConnection.prototype.addIceCandidate = function() {
...
function fe(r, e) {
  if (!(r.RTCPeerConnection && r.RTCPeerConnection.prototype))
    return;
  const n = r.RTCPeerConnection.prototype.setLocalDescription;
  !n || n.length === 0 || (r.RTCPeerConnection.prototype.setLocalDescription = function() {
    let i = arguments[0] || {};
...
const Wn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  removeExtmapAllowMixed: Qe,
  shimAddIceCandidateNullOrEmpty: ce,
  shimConnectionState: Ye,
  shimMaxMessageSize: oe,
  shimParameterlessSetLocalDescription: fe,
  shimRTCIceCandidate: se,
  shimRTCIceCandidateRelayProtocol: Ke,
  shimSendThrowTypeError: ae
}, Symbol.toStringTag, { value: "Module" }));
function Xn({ window: r } = {}, e = {
  shimChrome: !0,
  shimFirefox: !0,
  shimSafari: !0
}) {
  ...
  switch (t.browser) {
    case "chrome":
      ...
      n("adapter.js shimming chrome."), i.browserShim = ut, ce(r, t), fe(r), Qt(r, t), Wt(r), Ge(r, t), Xt(r), nn(r, t), Zt(r), en(r), rn(r, t), se(r), Ke(r), Ye(r), oe(r, t), ae(r), Qe(r, t);
      break;
    case "firefox":
      if (!lt || !He || !e.shimFirefox)
        return n("Firefox shim is not included in this adapter release."), i;
      n("adapter.js shimming firefox."), i.browserShim = lt, ce(r, t), fe(r), sn(r, t), He(r, t), on(r), fn(r), an(r), cn(r), un(r), ln(r), dn(r), hn(r), pn(r), se(r), Ye(r), oe(r, t), ae(r);
      break;
    case "safari":
      if (!dt || !e.shimSafari)
        return n("Safari shim is not included in this adapter release."), i;
      n("adapter.js shimming safari."), i.browserShim = dt, ce(r, t), fe(r), bn(r), Sn(r), yn(r), gn(r), mn(r), vn(r), _n(r), Tn(r), se(r), Ke(r), oe(r, t), ae(r), Qe(r, t);
      break;
    default:
...
const pt = Xn({ window: typeof window > "u" ? void 0 : window });
function J(r, e, n, t) {
...
class kn {
  constructor() {
    this.chunkedMTU = 16300, this._dataCount = 1, this.chunk = (e) => {
      const n = [], t = e.byteLength, i = Math.ceil(t / this.chunkedMTU);
      let s = 0, o = 0;
      for (; o < t; ) {
        const a = Math.min(t, o + this.chunkedMTU), c = e.slice(o, a), f = {
...
const be = (
  ...
  getBrowser() {
    return be.browserDetails.browser;
  }
  getVersion() {
    return be.browserDetails.version || 0;
  }
  isUnifiedPlanSupported() {
    const r = this.getBrowser(), e = be.browserDetails.version || 0;
    ...
    let n, t = !1;
    try {
      n = new RTCPeerConnection(), n.addTransceiver("audio"), t = !0;
    } catch {
    } finally {
      n && n.close();
    }
...
}(), er = (r) => !r || /^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(r), En = () => Math.random().toString(36).slice(2), gt = {
  iceServers: [
    {
...
class tr extends kn {
  ...
  constructor(...e) {
    ...
    this.defaultConfig = gt, this.browser = Z.getBrowser(), this.browserVersion = Z.getVersion(), this.pack = Jt, this.unpack = qt, /**
    ...
    */
    this.supports = (function() {
      const n = {
        browser: Z.isBrowserSupported(),
        webRTC: Z.isWebRTCSupported(),
        audioVideo: !1,
        data: !1,
        binaryBlob: !1,
        reliable: !1
      ...
      let t;
      try {
        t = new RTCPeerConnection(gt), n.audioVideo = !0;
        let i;
        try {
          i = t.createDataChannel("_PEERJSTEST", {
            ordered: !0
          }), n.data = !0, n.reliable = !!i.ordered;
          try {
            i.binaryType = "blob", n.binaryBlob = !Z.isIOS;
          } catch {
          }
        } catch {
        } finally {
    ...
    this.validateId = er, this.randomToken = En;
  }
}
const N = new tr(), nr = "PeerJS: ";
class rr {
  get logLevel() {
  ...
  _print(e, ...n) {
    ...
    for (const i in t) t[i] instanceof Error && (t[i] = "(" + t[i].name + ") " + t[i].message);
    e >= 3 ? console.log(...t) : e >= 2 ? console.warn("WARNING", ...t) : e >= 1 && console.error("ERROR", ...t);
  }
  constructor() {
    this._logLevel = 0;
  }
}
var p = new rr(), Ze = {}, ir = Object.prototype.hasOwnProperty, O = "~";
function ne() {
}
Object.create && (ne.prototype = /* @__PURE__ */ Object.create(null), new ne().__proto__ || (O = !1));
function sr(r, e, n) {
  this.fn = r, this.context = e, this.once = n || !1;
}
function xn(r, e, n, t, i) {
  if (typeof n != "function") throw new TypeError("The listener must be a function");
  var s = new sr(n, t || r, i), o = O ? O + e : e;
...
function ue(r, e) {
  --r._eventsCount === 0 ? r._events = new ne() : delete r._events[e];
}
function B() {
...
B.prototype.eventNames = function() {
  ...
  for (t in n = this._events) ir.call(n, t) && e.push(O ? t.slice(1) : t);
  return Object.getOwnPropertySymbols ? e.concat(Object.getOwnPropertySymbols(n)) : e;
};
B.prototype.listeners = function(e) {
  var n = O ? O + e : e, t = this._events[n];
  if (!t) return [];
  if (t.fn) return [
    t.fn
  ];
  for (var i = 0, s = t.length, o = new Array(s); i < s; i++) o[i] = t[i].fn;
  return o;
};
B.prototype.listenerCount = function(e) {
  var n = O ? O + e : e, t = this._events[n];
  return t ? t.fn ? 1 : t.length : 0;
};
B.prototype.emit = function(e, n, t, i, s, o) {
  var a = O ? O + e : e;
  if (!this._events[a]) return !1;
  var c = this._events[a], f = arguments.length, u, l;
  if (c.fn) {
    switch (c.once && this.removeListener(e, c.fn, void 0, !0), f) {
      ...
      case 3:
        return c.fn.call(c.context, n, t), !0;
      case 4:
        return c.fn.call(c.context, n, t, i), !0;
      case 5:
        return c.fn.call(c.context, n, t, i, s), !0;
      case 6:
        return c.fn.call(c.context, n, t, i, s, o), !0;
    }
    ...
    for (l = 0; l < d; l++)
      switch (c[l].once && this.removeListener(e, c[l].fn, void 0, !0), f) {
        ...
        case 2:
          ...
          break;
        case 3:
          c[l].fn.call(c[l].context, n, t);
          break;
        case 4:
          c[l].fn.call(c[l].context, n, t, i);
          break;
        default:
...
B.prototype.on = function(e, n, t) {
  return xn(this, e, n, t, !1);
};
B.prototype.once = function(e, n, t) {
  return xn(this, e, n, t, !0);
};
B.prototype.removeListener = function(e, n, t, i) {
  var s = O ? O + e : e;
  if (!this._events[s]) return this;
  if (!n)
    return ue(this, s), this;
  var o = this._events[s];
  if (o.fn)
    o.fn === n && (!i || o.once) && (!t || o.context === t) && ue(this, s);
  else {
    for (var a = 0, c = [], f = o.length; a < f; a++) (o[a].fn !== n || i && !o[a].once || t && o[a].context !== t) && c.push(o[a]);
    c.length ? this._events[s] = c.length === 1 ? c[0] : c : ue(this, s);
  }
  return this;
};
B.prototype.removeAllListeners = function(e) {
  var n;
  return e ? (n = O ? O + e : e, this._events[n] && ue(this, n)) : (this._events = new ne(), this._eventsCount = 0), this;
};
...
Ze = B;
var G = {};
J(G, "ConnectionType", () => V);
J(G, "PeerErrorType", () => D);
J(G, "BaseConnectionErrorType", () => We);
J(G, "DataConnectionErrorType", () => et);
J(G, "SerializationType", () => pe);
J(G, "SocketEventType", () => w);
J(G, "ServerMessageType", () => L);
...
const In = "1.5.5";
class or extends Ze.EventEmitter {
  constructor(e, n, t, i, s, o = 5e3) {
    super(), this.pingInterval = o, this._disconnected = !0, this._messagesQueue = [];
    const a = e ? "wss://" : "ws://";
    this._baseUrl = a + n + ":" + t + i + "peerjs?key=" + s;
  }
  start(e, n) {
    this._id = e;
    const t = `${this._baseUrl}&id=${e}&token=${n}`;
    this._socket || !this._disconnected || (this._socket = new WebSocket(t + "&version=" + In), this._disconnected = !1, this._socket.onmessage = (i) => {
      let s;
      try {
        s = JSON.parse(i.data), p.log("Server message received:", s);
      } catch {
        p.log("Invalid server message", i.data);
        return;
      }
      this.emit(w.Message, s);
    }, this._socket.onclose = (i) => {
      this._disconnected || (p.log("Socket closed.", i), this._cleanup(), this._disconnected = !0, this.emit(w.Disconnected));
    }, this._socket.onopen = () => {
  ...
  send(e) {
    ...
    if (!e.type) {
      this.emit(w.Error, "Invalid message");
      return;
    }
...
class Dn {
  ...
  startConnection(e) {
    ...
    if (this.connection.peerConnection = n, this.connection.type === V.Media && e._stream && this._addTracksToConnection(e._stream, n), e.originator) {
      const t = this.connection, i = {
        ordered: !!e.reliable
      }, s = n.createDataChannel(t.label, i);
      t._initializeDataChannel(s), this._makeOffer();
  ...
  _setupListeners(e) {
    const n = this.connection.peer, t = this.connection.connectionId, i = this.connection.type, s = this.connection.provider;
    p.log("Listening for ICE candidates."), e.onicecandidate = (o) => {
      !o.candidate || !o.candidate.candidate || (p.log(`Received ICE candidates for ${n}:`, o.candidate), s.socket.send({
        type: L.Candidate,
        payload: {
      ...
      switch (e.iceConnectionState) {
        case "failed":
          p.log("iceConnectionState is failed, closing connections to " + n), this.connection.emitError(We.NegotiationFailed, "Negotiation of connection to " + n + " failed."), this.connection.close();
          break;
        case "closed":
          p.log("iceConnectionState is closed, closing connections to " + n), this.connection.emitError(We.ConnectionClosed, "Connection to " + n + " closed."), this.connection.close();
          break;
        case "disconnected":
          p.log("iceConnectionState changed to disconnected on the connection with " + n);
          break;
        case "completed":
          e.onicecandidate = () => {
          };
    ...
    }, p.log("Listening for data channel"), e.ondatachannel = (o) => {
      p.log("Received data channel");
      const a = o.channel;
      s.getConnection(n, t)._initializeDataChannel(a);
    }, p.log("Listening for remote stream"), e.ontrack = (o) => {
      p.log("Received remote stream");
      const a = o.streams[0], c = s.getConnection(n, t);
      if (c.type === V.Media) {
        const f = c;
  ...
  cleanup() {
    ...
    i && (t = !!i.readyState && i.readyState !== "closed"), (n || t) && e.close();
  }
  async _makeOffer() {
    const e = this.connection.peerConnection, n = this.connection.provider;
    try {
      const t = await e.createOffer(this.connection.options.constraints);
      p.log("Created offer."), this.connection.options.sdpTransform && typeof this.connection.options.sdpTransform == "function" && (t.sdp = this.connection.options.sdpTransform(t.sdp) || t.sdp);
      try {
        await e.setLocalDescription(t), p.log("Set localDescription:", t, `for:${this.connection.peer}`);
        let i = {
          sdp: t,
        ...
        i != "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" && (n.emitError(D.WebRTC, i), p.log("Failed to setLocalDescription, ", i));
      }
    } catch (t) {
      n.emitError(D.WebRTC, t), p.log("Failed to createOffer, ", t);
    }
  }
  async _makeAnswer() {
    const e = this.connection.peerConnection, n = this.connection.provider;
    try {
      const t = await e.createAnswer();
      p.log("Created answer."), this.connection.options.sdpTransform && typeof this.connection.options.sdpTransform == "function" && (t.sdp = this.connection.options.sdpTransform(t.sdp) || t.sdp);
      try {
        await e.setLocalDescription(t), p.log("Set localDescription:", t, `for:${this.connection.peer}`), n.socket.send({
          type: L.Answer,
          payload: {
            sdp: t,
            type: this.connection.type,
        ...
        n.emitError(D.WebRTC, i), p.log("Failed to setLocalDescription, ", i);
      }
    } catch (t) {
      n.emitError(D.WebRTC, t), p.log("Failed to create answer, ", t);
    }
  }
  /** Handle an SDP. */
  async handleSDP(e, n) {
    n = new RTCSessionDescription(n);
    const t = this.connection.peerConnection, i = this.connection.provider;
    p.log("Setting remote description", n);
    const s = this;
    try {
      await t.setRemoteDescription(n), p.log(`Set remoteDescription:${e} for:${this.connection.peer}`), e === "OFFER" && await s._makeAnswer();
    } catch (o) {
      i.emitError(D.WebRTC, o), p.log("Failed to setRemoteDescription, ", o);
    }
  }
  /** Handle a candidate. */
  async handleCandidate(e) {
    ...
    try {
      ...
      this.connection.provider.emitError(D.WebRTC, n), p.log("Failed to handleCandidate, ", n);
    }
  }
  _addTracksToConnection(e, n) {
    if (p.log(`add tracks from stream ${e.id} to peer connection`), !n.addTrack) return p.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");
    e.getTracks().forEach((t) => {
      n.addTrack(t, e);
    });
  }
  _addStreamToMediaConnection(e, n) {
    p.log(`add stream ${e.id} to media connection ${n.connectionId}`), n.addStream(e);
  }
}
class Mn extends Ze.EventEmitter {
  /**
  ...
  */
  emitError(e, n) {
    p.error("Error:", n), this.emit("error", new ar(`${e}`, n));
  }
}
...
class An extends Mn {
  ...
  */
  ...
  constructor(e, n, t) {
    super(), this.peer = e, this.provider = n, this.options = t, this._open = !1, this.metadata = t.metadata;
  }
}
class le extends An {
  ...
  */
  ...
  constructor(e, n, t) {
    super(e, n, t), this._localStream = this.options._stream, this.connectionId = this.options.connectionId || le.ID_PREFIX + N.randomToken(), this._negotiator = new Dn(this), this._localStream && this._negotiator.startConnection({
  ...
  */
  handleMessage(e) {
    const n = e.type, t = e.payload;
    switch (e.type) {
      case L.Answer:
        this._negotiator.handleSDP(n, t.sdp), this._open = !0;
        break;
      case L.Candidate:
        this._negotiator.handleCandidate(t.candidate);
        break;
      default:
        p.warn(`Unrecognized message type:${n} from peer:${this.peer}`);
        break;
    }
  }
  /**
  ...
  answer(e, n = {}) {
    ...
    const t = this.provider._getMessages(this.connectionId);
    for (const i of t) this.handleMessage(i);
    this._open = !0;
  }
  /**
...
class cr {
  ...
  _buildRequest(e) {
    const n = this._options.secure ? "https" : "http", { host: t, port: i, path: s, key: o } = this._options, a = new URL(`${n}://${t}:${i}${s}${o}/${e}`);
    return a.searchParams.set("ts", `${Date.now()}${Math.random()}`), a.searchParams.set("version", In), fetch(a.href, {
  ...
  async retrieveId() {
    try {
      ...
      let n = "";
      throw this._options.path === "/" && this._options.host !== N.CLOUD_HOST && (n = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."), new Error("Could not get an ID from the server." + n);
    }
  }
  /** @deprecated */
  async listAllPeers() {
    try {
      ...
      throw p.error("Error retrieving list peers", e), new Error("Could not get list peers from the server." + e);
    }
  }
}
class de extends An {
  ...
  constructor(e, n, t) {
    super(e, n, t), this.connectionId = this.options.connectionId || de.ID_PREFIX + En(), this.label = this.options.label || this.connectionId, this.reliable = !!this.options.reliable, this._negotiator = new Dn(this), this._negotiator.startConnection(this.options._payload || {
      originator: !0,
  ...
  _initializeDataChannel(e) {
    this.dataChannel = e, this.dataChannel.onopen = () => {
      ...
      p.log(`DC#${this.connectionId} dc onmessage:`, n.data);
    }, this.dataChannel.onclose = () => {
      p.log(`DC#${this.connectionId} dc closed for:`, this.peer), this.close();
    };
  }
  ...
  */
  ...
  send(e, n = !1) {
    if (!this.open) {
      this.emitError(et.NotOpenYet, "Connection is not open. You should listen for the `open` event before sending messages.");
      return;
    }
  ...
  async handleMessage(e) {
    ...
    switch (e.type) {
      ...
      case L.Candidate:
        ...
        break;
      default:
        p.warn("Unrecognized message type:", e.type, "from peer:", this.peer);
        break;
    }
  }
}
class tt extends de {
  ...
  _trySend(e) {
    ...
    if (this.dataChannel.bufferedAmount > de.MAX_BUFFERED_AMOUNT)
    ...
    try {
      ...
      return p.error(`DC#:${this.connectionId} Error when sending:`, n), this._buffering = !0, this.close(), !1;
    }
    return !0;
  }
...
class ve extends tt {
  ...
  constructor(e, n, t) {
    super(e, n, t), this.chunker = new kn(), this.serialization = pe.Binary, this._chunkedData = {};
  }
  // Handles a DataChannel message.
  _handleDataMessage({ data: e }) {
    const n = qt(e), t = n.__peerData;
    if (t) {
      if (t.type === "close") {
        this.close();
        return;
  ...
  _handleChunk(e) {
    const n = e.__peerData, t = this._chunkedData[n] || {
      data: [],
      count: 0,
      total: e.total
    };
    if (t.data[e.n] = new Uint8Array(e.data), t.count++, this._chunkedData[n] = t, t.total === t.count) {
  ...
  _send(e, n) {
    const t = Jt(e);
    if (t instanceof Promise) return this._send_blob(t);
    if (!n && t.byteLength > this.chunker.chunkedMTU) {
      this._sendChunks(t);
      return;
    }
  ...
  _sendChunks(e) {
    ...
    p.log(`DC#${this.connectionId} Try to send ${n.length} chunks...`);
    for (const t of n) this.send(t, !0);
  }
}
class fr extends tt {
  _handleDataMessage({ data: e }) {
  ...
  constructor(...e) {
    super(...e), this.serialization = pe.None;
  }
}
class ur extends tt {
  // Handles a DataChannel message.
  _handleDataMessage({ data: e }) {
    const n = this.parse(this.decoder.decode(e)), t = n.__peerData;
    if (t && t.type === "close") {
      this.close();
      return;
    }
  ...
  _send(e, n) {
    const t = this.encoder.encode(this.stringify(e));
    if (t.byteLength >= N.chunkedMTU) {
      this.emitError(et.MessageToBig, "Message too big for JSON channel");
      return;
    }
    this._bufferedSend(t);
  }
  constructor(...e) {
    super(...e), this.serialization = pe.JSON, this.encoder = new TextEncoder(), this.decoder = new TextDecoder(), this.stringify = JSON.stringify, this.parse = JSON.parse;
  }
}
class nt extends Mn {
  ...
  */
  get connections() {
    ...
    for (const [n, t] of this._connections) e[n] = t;
    return e;
  }
  /**
  ...
  */
  ...
  constructor(e, n) {
    ...
    let t;
    if (e && e.constructor == Object ? n = e : e && (t = e.toString()), n = {
      debug: 0,
      host: N.CLOUD_HOST,
      port: N.CLOUD_PORT,
      path: "/",
    ...
    }, this._options.host === "/" && (this._options.host = window.location.hostname), this._options.path && (this._options.path[0] !== "/" && (this._options.path = "/" + this._options.path), this._options.path[this._options.path.length - 1] !== "/" && (this._options.path += "/")), this._options.secure === void 0 && this._options.host !== N.CLOUD_HOST ? this._options.secure = N.isSecure() : this._options.host == N.CLOUD_HOST && (this._options.secure = !0), this._options.logFunction && p.setLogFunction(this._options.logFunction), p.logLevel = this._options.debug || 0, this._api = new cr(n), this._socket = this._createServerConnection(), !N.supports.audioVideo && !N.supports.data) {
      this._delayedAbort(D.BrowserIncompatible, "The current browser does not support WebRTC");
      return;
    }
    if (t && !N.validateId(t)) {
      this._delayedAbort(D.InvalidID, `ID "${t}" is invalid`);
      return;
    }
    t ? this._initialize(t) : this._api.retrieveId().then((i) => this._initialize(i)).catch((i) => this._abort(D.ServerError, i));
  }
  _createServerConnection() {
    const e = new or(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key, this._options.pingInterval);
    return e.on(w.Message, (n) => {
      this._handleMessage(n);
    }), e.on(w.Error, (n) => {
      this._abort(D.SocketError, n);
    }), e.on(w.Disconnected, () => {
      this.disconnected || (this.emitError(D.Network, "Lost connection to server."), this.disconnect());
    }), e.on(w.Close, () => {
      this.disconnected || this._abort(D.SocketClosed, "Underlying socket is already closed.");
    }), e;
  }
  ...
  _handleMessage(e) {
    const n = e.type, t = e.payload, i = e.src;
    switch (n) {
      case L.Open:
        this._lastServerId = this.id, this._open = !0, this.emit("open", this.id);
        break;
      case L.Error:
        this._abort(D.ServerError, t.msg);
        break;
      case L.IdTaken:
        this._abort(D.UnavailableID, `ID "${this.id}" is taken`);
        break;
      case L.InvalidKey:
        this._abort(D.InvalidKey, `API KEY "${this._options.key}" is invalid`);
        break;
      case L.Leave:
        p.log(`Received leave message from ${i}`), this._cleanupPeer(i), this._connections.delete(i);
        break;
      case L.Expire:
        this.emitError(D.PeerUnavailable, `Could not connect to peer ${i}`);
        break;
      case L.Offer: {
        const s = t.connectionId;
        let o = this.getConnection(i, s);
        if (o && (o.close(), p.warn(`Offer received for existing Connection ID:${s}`)), t.type === V.Media) {
          const c = new le(i, this, {
            connectionId: s,
            _payload: t,
            metadata: t.metadata
          });
          o = c, this._addConnection(i, o), this.emit("call", c);
        } else if (t.type === V.Data) {
          const c = new this._serializers[t.serialization](i, this, {
            connectionId: s,
            _payload: t,
            metadata: t.metadata,
            label: t.label,
          ...
          p.warn(`Received malformed connection type:${t.type}`);
          return;
        }
      ...
      default: {
        if (!t) {
          p.warn(`You received a malformed message from ${i} of type ${n}`);
          return;
        }
        const s = t.connectionId, o = this.getConnection(i, s);
        o && o.peerConnection ? o.handleMessage(e) : s ? this._storeMessage(s, e) : p.warn("You received an unrecognized message:", e);
        break;
      }
    }
  }
  ...
  */
  connect(e, n = {}) {
    ...
    const t = new this._serializers[n.serialization](e, this, n);
  ...
  */
  call(e, n, t = {}) {
    if (this.disconnected) {
      p.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."), this.emitError(D.Disconnected, "Cannot connect to new Peer after disconnecting from server.");
      return;
    }
    if (!n) {
  ...
  _addConnection(e, n) {
    p.log(`add connection ${n.type}:${n.connectionId} to peerId:${e}`), this._connections.has(e) || this._connections.set(e, []), this._connections.get(e).push(n);
  }
  ...
  */
  _abort(e, n) {
    p.error("Aborting!"), this.emitError(e, n), this._lastServerId ? this.disconnect() : this.destroy();
  }
  /**
  ...
  */
  reconnect() {
    if (this.disconnected && !this.destroyed)
      p.log(`Attempting reconnection to server with ID ${this._lastServerId}`), this._disconnected = !1, this._initialize(this._lastServerId);
    else {
      ...
      if (!this.disconnected && !this.open)
        p.error("In a hurry? We're still trying to make the initial connection!");
  ...
  */
  listAllPeers(e = (n) => {
    ...
    this._api.listAllPeers().then((n) => e(n)).catch((n) => this._abort(D.ServerError, n));
  }
}
var he = nt;
class Br {
  constructor(e) {
    this._playerId = null, this._dataConnection = null, this._playerName = null, this._peer = e ? new he(e) : new he(), this._ownIdPromise = new Promise((n, t) => {
      const i = setTimeout(
        () => t(new Error("Peer ID not assigned in time")),
        1e4
      );
      this._peer.on("open", (s) => {
        clearTimeout(i), this._playerId = s, n(s);
      }), this._peer.on("error", (s) => {
        clearTimeout(i), t(s);
      });
    }), this._peer.on("error", (n) => {
      console.error("PeerJS error:", n.type, n.message);
      ...
      if (this._dataConnection?.open && this._playerId !== null) {
        ...
        try {
          this._dataConnection.send(n);
        } catch (t) {
          console.warn("Failed to send LEAVE:", t);
        }
      }
      this._dataConnection?.close(), this._peer.destroy();
    });
  }
  async joinMatch(e) {
    this._playerName = e;
    const t = new URLSearchParams(window.location.search).get("hostPeerId");
    if (!t)
      throw new Error("No hostPeerId found in URL parameters.");
    const i = this._peer.connect(t, {
      reliable: !1
    });
    this._dataConnection = i, await new Promise((s, o) => {
      const a = setTimeout(() => {
        i.close(), o(new Error("Connection timeout"));
      }, 15e3);
      i.on("open", () => {
        if (clearTimeout(a), this._playerId) {
          const c = {
            playerId: this._playerId,
            action: "JOIN",
            playerName: this._playerName || "",
          ...
          i.send(c), console.log("JOIN sent, data connection open"), s();
        } else
          this._ownIdPromise.then((c) => {
            const f = {
              playerId: c,
              action: "JOIN",
              playerName: this._playerName || "",
            ...
            i.send(f), console.log("JOIN sent, data connection open"), s();
          }).catch(o);
      }), i.on("error", (c) => {
        clearTimeout(a), o(c);
      });
    }), i.on("data", (s) => {
      console.log("Received from host:", s);
    }), i.on("close", () => {
      console.log("Data connection closed by host"), this._dataConnection = null;
    });
  }
  async sendMove(e) {
...
function hr() {
  ...
  return r.prototype.set = function(e, n, t, i) {
    const s = e * this.size + n;
    this.data[s] = t, i && (this.reservedBit[s] = !0);
  }, r.prototype.get = function(e, n) {
    return this.data[e * this.size + n];
  }, r.prototype.xor = function(e, n, t) {
...
function pr() {
  return vt || (vt = 1, (function(r) {
    const e = H().getSymbolSize;
    r.getRowColCoords = function(t) {
      if (t === 1) return [];
      const i = Math.floor(t / 7) + 2, s = e(t), o = s === 145 ? 26 : Math.ceil((s - 13) / (2 * i - 2)) * 2, a = [s - 7];
      for (let c = 1; c < i - 1; c++)
        a[c] = a[c - 1] - o;
      return a.push(6), a.reverse();
    }, r.getPositions = function(t) {
      const i = [], s = r.getRowColCoords(t), o = s.length;
      for (let a = 0; a < o; a++)
        for (let c = 0; c < o; c++)
          a === 0 && c === 0 || // top-left
...
function gr() {
  if (St) return xe;
  St = 1;
  const r = H().getSymbolSize, e = 7;
  return xe.getPositions = function(t) {
    const i = r(t);
    return [
      // top-left
      [0, 0],
...
function mr() {
  return Tt || (Tt = 1, (function(r) {
    ...
    r.isValid = function(i) {
      ...
      const s = i.size;
      let o = 0, a = 0, c = 0, f = null, u = null;
      for (let l = 0; l < s; l++) {
        a = c = 0, f = u = null;
        for (let d = 0; d < s; d++) {
          let h = i.get(l, d);
          h === f ? a++ : (a >= 5 && (o += e.N1 + (a - 5)), f = h, a = 1), h = i.get(d, l), h === u ? c++ : (c >= 5 && (o += e.N1 + (c - 5)), u = h, c = 1);
        }
      ...
      for (let a = 0; a < s - 1; a++)
        for (let c = 0; c < s - 1; c++) {
          const f = i.get(a, c) + i.get(a, c + 1) + i.get(a + 1, c) + i.get(a + 1, c + 1);
          (f === 4 || f === 0) && o++;
        }
      return o * e.N2;
      ...
      for (let f = 0; f < s; f++) {
        a = c = 0;
        for (let u = 0; u < s; u++)
          a = a << 1 & 2047 | i.get(f, u), u >= 10 && (a === 1488 || a === 93) && o++, c = c << 1 & 2047 | i.get(u, f), u >= 10 && (c === 1488 || c === 93) && o++;
      }
      return o * e.N3;
    ...
    r.applyMask = function(i, s) {
      ...
      for (let a = 0; a < o; a++)
        for (let c = 0; c < o; c++)
          s.isReserved(c, a) || s.xor(c, a, n(i, c, a));
    }, r.getBestMask = function(i, s) {
      const o = Object.keys(r.Patterns).length;
      let a = 0, c = 1 / 0;
      for (let f = 0; f < o; f++) {
        s(f), r.applyMask(f, i);
        const u = r.getPenaltyN1(i) + r.getPenaltyN2(i) + r.getPenaltyN3(i) + r.getPenaltyN4(i);
        r.applyMask(f, i), u < c && (c = u, a = f);
      }
      return a;
    };
  })(Ie)), Ie;
...
function Ln() {
  ...
  return ie.getBlocksCount = function(i, s) {
    switch (s) {
      case r.L:
        return e[(i - 1) * 4 + 0];
      case r.M:
  ...
  }, ie.getTotalCodewordsCount = function(i, s) {
    switch (s) {
      case r.L:
        return n[(i - 1) * 4 + 0];
      case r.M:
...
function _r() {
  return kt || (kt = 1, (function(r) {
    const e = yr();
    r.mul = function(t, i) {
      const s = new Uint8Array(t.length + i.length - 1);
...
var Ae = {}, Le = {}, Be = {}, xt;
function Bn() {
  return xt || (xt = 1, Be.isValid = function(e) {
...
function On() {
  ...
  U.KANJI = new RegExp(n, "g"), U.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), U.BYTE = new RegExp(t, "g"), U.NUMERIC = new RegExp(r, "g"), U.ALPHANUMERIC = new RegExp(e, "g");
  const i = new RegExp("^" + n + "$"), s = new RegExp("^" + r + "$"), o = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
function K() {
  return Dt || (Dt = 1, (function(r) {
    ...
    r.NUMERIC = {
      ...
      return n.testNumeric(s) ? r.NUMERIC : n.testAlphanumeric(s) ? r.ALPHANUMERIC : n.testKanji(s) ? r.KANJI : r.BYTE;
...
function br() {
  return Mt || (Mt = 1, (function(r) {
    const e = H(), n = Ln(), t = rt(), i = K(), s = Bn(), o = 7973, a = e.getBCHDigit(o);
    function c(d, h, g) {
      for (let _ = 1; _ <= 40; _++)
        if (h <= r.getCapacity(_, g, d))
          return _;
    }
    function f(d, h) {
      return i.getCharCountIndicator(d, h) + 4;
    }
    function u(d, h) {
      let g = 0;
    ...
    function l(d, h) {
      for (let g = 1; g <= 40; g++)
        if (u(d, g) <= r.getCapacity(g, h, i.MIXED))
          return g;
    }
    r.from = function(h, g) {
      return s.isValid(h) ? parseInt(h, 10) : g;
    }, r.getCapacity = function(h, g, _) {
      if (!s.isValid(h))
        throw new Error("Invalid QR Code version");
      typeof _ > "u" && (_ = i.BYTE);
      const M = e.getSymbolTotalCodewords(h), k = n.getTotalCodewordsCount(h, g), I = (M - k) * 8;
      if (_ === i.MIXED) return I;
      const E = I - f(_, h);
      switch (_) {
        case i.NUMERIC:
    ...
    }, r.getBestVersionForData = function(h, g) {
      let _;
      const M = t.from(g, t.M);
      if (Array.isArray(h)) {
        if (h.length > 1)
          return l(h, M);
        if (h.length === 0)
...
function vr() {
  if (At) return Oe;
  At = 1;
  const r = H(), e = 1335, n = 21522, t = r.getBCHDigit(e);
  return Oe.getEncodedBits = function(s, o) {
    const a = s.bit << 3 | o;
    let c = a << 10;
    for (; r.getBCHDigit(c) - t >= 0; )
      c ^= e << r.getBCHDigit(c) - t;
    return (a << 10 | c) ^ n;
  }, Oe;
}
var Ne = {}, Ue, Lt;
function Sr() {
  ...
  return e.getBitsLength = function(t) {
    ...
    for (i = 0; i + 3 <= this.data.length; i += 3)
      s = this.data.substr(i, 3), o = parseInt(s, 10), t.put(o, 10);
    const a = this.data.length - i;
    a > 0 && (s = this.data.substr(i), o = parseInt(s, 10), t.put(o, a * 3 + 1));
  }, Ue = e, Ue;
}
var $e, Bt;
function Tr() {
...
function Rr() {
  ...
  const r = K();
  function e(n) {
    this.mode = r.BYTE, typeof n == "string" ? this.data = new TextEncoder().encode(n) : this.data = new Uint8Array(n);
  }
  return e.getBitsLength = function(t) {
    return t * 8;
  }, e.prototype.getLength = function() {
...
function kr() {
  return Ut || (Ut = 1, (function(r) {
    var e = {
      single_source_shortest_paths: function(n, t, i) {
        var s = {}, o = {};
        o[t] = 0;
        var a = e.PriorityQueue.make();
        a.push(t, 0);
        for (var c, f, u, l, d, h, g, _, M; !a.empty(); ) {
          c = a.pop(), f = c.value, l = c.cost, d = n[f] || {};
          for (u in d)
            d.hasOwnProperty(u) && (h = d[u], g = l + h, _ = o[u], M = typeof o[u] > "u", (M || _ > g) && (o[u] = g, a.push(u, g), s[u] = f));
        }
        if (typeof i < "u" && typeof o[i] > "u") {
          var k = ["Could not find a path from ", t, " to ", i, "."].join("");
          throw new Error(k);
        }
        return s;
      },
      ...
      find_path: function(n, t, i) {
        var s = e.single_source_shortest_paths(n, t, i);
      ...
      PriorityQueue: {
        make: function(n) {
          var t = e.PriorityQueue, i = {}, s;
          n = n || {};
          for (s in t)
            t.hasOwnProperty(s) && (i[s] = t[s]);
          return i.queue = [], i.sorter = n.sorter || t.default_sorter, i;
        },
...
function Er() {
  return $t || ($t = 1, (function(r) {
    const e = K(), n = Sr(), t = Tr(), i = Rr(), s = Pr(), o = On(), a = H(), c = kr();
    function f(k) {
    ...
    function l(k) {
      const I = u(o.NUMERIC, e.NUMERIC, k), E = u(o.ALPHANUMERIC, e.ALPHANUMERIC, k);
      let R, A;
      return a.isKanjiModeEnabled() ? (R = u(o.BYTE, e.BYTE, k), A = u(o.KANJI, e.KANJI, k)) : (R = u(o.BYTE_KANJI, e.BYTE, k), A = []), I.concat(E, R, A).sort(function(S, v) {
        return S.index - v.index;
      }).map(function(S) {
        return {
          data: S.data,
          mode: S.mode,
    ...
    function h(k) {
      return k.reduce(function(I, E) {
        const R = I.length - 1 >= 0 ? I[I.length - 1] : null;
        return R && R.mode === E.mode ? (I[I.length - 1].data += E.data, I) : (I.push(E), I);
      }, []);
    }
    function g(k) {
      const I = [];
      for (let E = 0; E < k.length; E++) {
        ...
        switch (R.mode) {
          case e.NUMERIC:
            I.push([
              R,
              { data: R.data, mode: e.ALPHANUMERIC, length: R.length },
          ...
          case e.KANJI:
            I.push([
              R,
              { data: R.data, mode: e.BYTE, length: f(R.data) }
            ]);
            break;
          case e.BYTE:
            I.push([
    ...
    function _(k, I) {
      ...
      for (let y = 0; y < k.length; y++) {
        ...
        for (let m = 0; m < S.length; m++) {
          const P = S[m], C = "" + y + m;
          v.push(C), E[C] = { node: P, lastCount: 0 }, R[C] = {};
          for (let T = 0; T < A.length; T++) {
            const b = A[T];
            E[b] && E[b].node.mode === P.mode ? (R[b][C] = d(E[b].lastCount + P.length, P.mode) - d(E[b].lastCount, P.mode), E[b].lastCount += P.length) : (E[b] && (E[b].lastCount = P.length), R[b][C] = d(P.length, P.mode) + 4 + e.getCharCountIndicator(P.mode, I));
          }
        }
        A = v;
      }
    ...
    function M(k, I) {
      let E;
      const R = e.getBestModeForData(k);
      if (E = e.from(I, R), E !== e.BYTE && E.bit < R.bit)
        throw new Error('"' + k + '" cannot be encoded with mode ' + e.toString(E) + `.
 Suggested mode is: ` + e.toString(R));
      switch (E === e.KANJI && !a.isKanjiModeEnabled() && (E = e.BYTE), E) {
        case e.NUMERIC:
          return new n(k);
        case e.ALPHANUMERIC:
          return new t(k);
    ...
    r.fromArray = function(I) {
      return I.reduce(function(E, R) {
        return typeof R == "string" ? E.push(M(R, null)) : R.data && E.push(M(R.data, R.mode)), E;
      }, []);
    }, r.fromString = function(I, E) {
      const R = l(I, a.isKanjiModeEnabled()), A = g(R), y = _(A, E), S = c.find_path(y.map, "start", "end"), v = [];
      for (let m = 1; m < S.length - 1; m++)
        v.push(y.table[S[m]].node);
      return r.fromArray(h(v));
    }, r.rawSplit = function(I) {
      return r.fromArray(
        l(I, a.isKanjiModeEnabled())
      );
    };
  })(Ne)), Ne;
}
...
function xr() {
  if (Ft) return Te;
  Ft = 1;
  const r = H(), e = rt(), n = dr(), t = hr(), i = pr(), s = gr(), o = mr(), a = Ln(), c = Cr(), f = br(), u = vr(), l = K(), d = Er();
  function h(y, S) {
    const v = y.size, m = s.getPositions(S);
    for (let P = 0; P < m.length; P++) {
      const C = m[P][0], T = m[P][1];
      for (let b = -1; b <= 7; b++)
        if (!(C + b <= -1 || v <= C + b))
          for (let x = -1; x <= 7; x++)
            T + x <= -1 || v <= T + x || (b >= 0 && b <= 6 && (x === 0 || x === 6) || x >= 0 && x <= 6 && (b === 0 || b === 6) || b >= 2 && b <= 4 && x >= 2 && x <= 4 ? y.set(C + b, T + x, !0, !0) : y.set(C + b, T + x, !1, !0));
    }
  }
  function g(y) {
    const S = y.size;
    for (let v = 8; v < S - 8; v++) {
      const m = v % 2 === 0;
      y.set(v, 6, m, !0), y.set(6, v, m, !0);
    }
  }
  function _(y, S) {
    const v = i.getPositions(S);
    for (let m = 0; m < v.length; m++) {
      const P = v[m][0], C = v[m][1];
      for (let T = -2; T <= 2; T++)
        for (let b = -2; b <= 2; b++)
          T === -2 || T === 2 || b === -2 || b === 2 || T === 0 && b === 0 ? y.set(P + T, C + b, !0, !0) : y.set(P + T, C + b, !1, !0);
    }
  }
  function M(y, S) {
    const v = y.size, m = f.getEncodedBits(S);
    let P, C, T;
    for (let b = 0; b < 18; b++)
      P = Math.floor(b / 3), C = b % 3 + v - 8 - 3, T = (m >> b & 1) === 1, y.set(P, C, T, !0), y.set(C, P, T, !0);
  }
  function k(y, S, v) {
    const m = y.size, P = u.getEncodedBits(S, v);
    let C, T;
    for (C = 0; C < 15; C++)
      T = (P >> C & 1) === 1, C < 6 ? y.set(C, 8, T, !0) : C < 8 ? y.set(C + 1, 8, T, !0) : y.set(m - 15 + C, 8, T, !0), C < 8 ? y.set(8, m - C - 1, T, !0) : C < 9 ? y.set(8, 15 - C - 1 + 1, T, !0) : y.set(8, 15 - C - 1, T, !0);
    y.set(m - 8, 8, 1, !0);
  }
  function I(y, S) {
    const v = y.size;
    let m = -1, P = v - 1, C = 7, T = 0;
    for (let b = v - 1; b > 0; b -= 2)
      for (b === 6 && b--; ; ) {
        for (let x = 0; x < 2; x++)
          if (!y.isReserved(P, b - x)) {
            let j = !1;
            T < S.length && (j = (S[T] >>> C & 1) === 1), y.set(P, b - x, j), C--, C === -1 && (T++, C = 7);
          }
        if (P += m, P < 0 || v <= P) {
          P -= m, m = -m;
          break;
  ...
  function E(y, S, v) {
    ...
    v.forEach(function(x) {
      m.put(x.mode.bit, 4), m.put(x.getLength(), l.getCharCountIndicator(x.mode, y)), x.write(m);
    });
    const P = r.getSymbolTotalCodewords(y), C = a.getTotalCodewordsCount(y, S), T = (P - C) * 8;
    for (m.getLengthInBits() + 4 <= T && m.put(0, 4); m.getLengthInBits() % 8 !== 0; )
      m.putBit(0);
    const b = (T - m.getLengthInBits()) / 8;
    for (let x = 0; x < b; x++)
      m.put(x % 2 ? 17 : 236, 8);
    return R(m, y, S);
  }
  function R(y, S, v) {
    const m = r.getSymbolTotalCodewords(S), P = a.getTotalCodewordsCount(S, v), C = m - P, T = a.getBlocksCount(S, v), b = m % T, x = T - b, j = Math.floor(m / T), X = Math.floor(C / T), Un = X + 1, it = j - X, $n = new c(it);
    let ge = 0;
    const re = new Array(T), st = new Array(T);
    let me = 0;
    const Fn = new Uint8Array(y.buffer);
    for (let Y = 0; Y < T; Y++) {
      const _e = Y < x ? X : Un;
      re[Y] = Fn.slice(ge, ge + _e), st[Y] = $n.encode(re[Y]), ge += _e, me = Math.max(me, _e);
    }
    const ye = new Uint8Array(m);
    let ot = 0, $, F;
    for ($ = 0; $ < me; $++)
      for (F = 0; F < T; F++)
        $ < re[F].length && (ye[ot++] = re[F][$]);
    for ($ = 0; $ < it; $++)
      for (F = 0; F < T; F++)
        ye[ot++] = st[F][$];
    return ye;
  ...
  function A(y, S, v, m) {
    ...
    if (Array.isArray(y))
      ...
      let j = S;
      if (!j) {
        const X = d.rawSplit(y);
        j = f.getBestVersionForData(X, v);
      }
      P = d.fromString(y, j || 40);
    } else
      throw new Error("Invalid data");
    const C = f.getBestVersionForData(P, v);
    if (!C)
...
`
    ...
    const T = E(S, v, P), b = r.getSymbolSize(S), x = new t(b);
    return h(x, S), g(x), _(x, S), k(x, v, 0), S >= 7 && M(x, S), I(x, T), isNaN(m) && (m = o.getBestMask(
      x,
      k.bind(null, x, v)
    )), o.applyMask(m, x), k(x, v, m), {
      modules: x,
      version: S,
  ...
  return Te.create = function(S, v) {
    if (typeof S > "u" || S === "")
      throw new Error("No input text");
    let m = e.M, P, C;
    return typeof v < "u" && (m = e.from(v.errorCorrectionLevel, e.M), P = f.from(v.version), C = o.from(v.maskPattern), v.toSJISFunc && r.setToSJISFunction(v.toSJISFunc)), A(S, P, m, C);
  }, Te;
}
var we = {}, Ve = {}, jt;
function Nn() {
  return jt || (jt = 1, (function(r) {
    function e(n) {
      ...
      (t.length === 3 || t.length === 4) && (t = Array.prototype.concat.apply([], t.map(function(s) {
        return [s, s];
      }))), t.length === 6 && t.push("F", "F");
      const i = parseInt(t.join(""), 16);
      return {
        r: i >> 24 & 255,
        g: i >> 16 & 255,
        b: i >> 8 & 255,
    ...
    r.getOptions = function(t) {
      t || (t = {}), t.color || (t.color = {});
      const i = typeof t.margin > "u" || t.margin === null || t.margin < 0 ? 4 : t.margin, s = t.width && t.width >= 21 ? t.width : void 0, o = t.scale || 4;
      return {
        width: s,
        scale: s ? 4 : o,
        margin: i,
    ...
    }, r.getScale = function(t, i) {
      return i.width && i.width >= t + i.margin * 2 ? i.width / (t + i.margin * 2) : i.scale;
    }, r.getImageWidth = function(t, i) {
      const s = r.getScale(t, i);
      return Math.floor((t + i.margin * 2) * s);
    }, r.qrToImageData = function(t, i, s) {
      const o = i.modules.size, a = i.modules.data, c = r.getScale(o, s), f = Math.floor((o + s.margin * 2) * c), u = s.margin * c, l = [s.color.light, s.color.dark];
      for (let d = 0; d < f; d++)
        for (let h = 0; h < f; h++) {
          let g = (d * f + h) * 4, _ = s.color.light;
          if (d >= u && h >= u && d < f - u && h < f - u) {
            const M = Math.floor((d - u) / c), k = Math.floor((h - u) / c);
            _ = l[a[M * o + k] ? 1 : 0];
          }
          t[g++] = _.r, t[g++] = _.g, t[g++] = _.b, t[g] = _.a;
        }
    };
  })(Ve)), Ve;
}
...
function Ir() {
  return zt || (zt = 1, (function(r) {
    ...
    r.render = function(s, o, a) {
      let c = a, f = o;
      typeof c > "u" && (!o || !o.getContext) && (c = o, o = void 0), o || (f = t()), c = e.getOptions(c);
      const u = e.getImageWidth(s.modules.size, c), l = f.getContext("2d"), d = l.createImageData(u, u);
      return e.qrToImageData(d.data, s, c), n(l, f, u), l.putImageData(d, 0, 0), f;
    }, r.renderToDataURL = function(s, o, a) {
      let c = a;
      typeof c > "u" && (!o || !o.getContext) && (c = o, o = void 0), c || (c = {});
      const f = r.render(s, o, c), u = c.type || "image/png", l = c.rendererOpts || {};
      return f.toDataURL(u, l.quality);
    };
  })(we)), we;
}
var qe = {}, wt;
...
function Mr() {
  if (Vt) return Q;
  Vt = 1;
  const r = lr(), e = xr(), n = Ir(), t = Dr();
  function i(s, o, a, c, f) {
    const u = [].slice.call(arguments, 1), l = u.length, d = typeof u[l - 1] == "function";
    if (!d && !r())
      throw new Error("Callback required as last argument");
    if (d) {
      if (l < 2)
        throw new Error("Too few arguments provided");
      l === 2 ? (f = a, a = o, o = c = void 0) : l === 3 && (o.getContext && typeof f > "u" ? (f = c, c = void 0) : (f = c, c = a, a = o, o = void 0));
    } else {
      if (l < 1)
        throw new Error("Too few arguments provided");
      return l === 1 ? (a = o, o = c = void 0) : l === 2 && !o.getContext && (c = a, a = o, o = void 0), new Promise(function(h, g) {
        try {
    ...
    try {
      const h = e.create(a, c);
      f(null, s(h, o, c));
    } catch (h) {
      f(h);
    }
  }
  return Q.create = e.create, Q.toCanvas = i.bind(null, n.render), Q.toDataURL = i.bind(null, n.renderToDataURL), Q.toString = i.bind(null, function(s, o, a) {
    return t.render(s, a);
  }), Q;
}
var Ar = Mr();
...
class Or {
  ...
  getInvitationStatus(e) {
    return this._invitationAccepted.get(e);
  }
  destroy() {
